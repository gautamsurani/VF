...
public class ProductListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocalVedicDB = new LocalVedicDB(ProductListActivity.this, FinalLocalDBName);
        ...
        mProductListAdapter = new ProductListAdapter(ProductListActivity.this, productList, mLocalVedicDB, WishLocalArrFOrStartView);
    ...
    private class GetProductDetailDataTask extends AsyncTask<Void, Void,
        ...
        protected Api_Model doInBackground(Void... params) {
            try {
                ...
                Api_Model curators = methods.GetProductListAPI("product", subCatId, Integer.toString(pagecode), filtertype);
                return curators;
            } catch (Exception E) {
